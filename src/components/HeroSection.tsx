...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-16">
      ...
      <div className="container relative z-10 flex flex-col items-center text-center gap-6 py-12">
        {/* Badge */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 text-primary text-sm font-medium"
        >
          🚀 Windows 10/11 · Free Forever · Made by Students at NIT Silchar
        </motion.div>
        ...
        <motion.img
          ...
          width={200}
          height={200}
          className="animate-float drop-shadow-[0_0_60px_hsl(187_100%_42%/0.5)]"
        />
        ...
        <motion.p
          ...
          className="text-xs text-muted-foreground/50 max-w-md flex items-center gap-1.5 justify-center"
        >
